...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button functionListBleBtn = findViewById(R.id.functionListBleBtn);
        functionListBleBtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button functionListWifiBtn = findViewById(R.id.functionListWifiBtn);
        functionListWifiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (PPScale.isBluetoothOpened()) {
                    Intent intent = new Intent(MainActivity.this, WifiFunctionListActivity.class);
                    startActivity(intent);
                } else {
                    PPScale.openBluetooth();
                }
