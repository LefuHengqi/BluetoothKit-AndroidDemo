...
import com.lefu.ppblutoothkit.device.foodscale.vo.Nutrient
import com.lefu.ppblutoothkit.device.foodscale.vo.Measure
import com.lefu.ppblutoothkit.device.foodscale.vo.Claim
import com.lefu.ppblutoothkit.device.foodscale.vo.toPPKorreFoodInfo
import com.lefu.ppblutoothkit.device.instance.PPBluetoothPeripheralLorreInstance
import com.lefu.ppblutoothkit.device.lorre.foodScaleDataChangeListener
 ...
 * 设备类型 厨房秤
 */
class PeripheralLorreActivity : BaseImmersivePermissionActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.peripheral_lorre_layout)
        ...
        initClick()
        deviceModel?.let { it1 -> PPBluetoothPeripheralLorreInstance.startConnect(it1, foodScaleDataChangeListener, bleStateInterface) }
    }
    ...
    private fun initToolbar() {
        ...
        toolbar?.let {
            setupUnifiedToolbar(
                toolbar = it,
                title = "Lorre:${deviceModel?.deviceName}",
                showBackButton = true
            )
        }
    }
    ...
    fun initClick() {
        ...
        findViewById<Button>(R.id.syncUnit).setOnClickListener {
            addPrint("syncUnit")
            PPBluetoothPeripheralLorreInstance.syncUnit(PPUnitType.Unit_LB, object : PPBleSendResultCallBack {
        ...
        findViewById<Button>(R.id.device_set_sync_log).setOnClickListener {
            ...
            PPBluetoothPeripheralLorreInstance.syncLog(fileFath, deviceLogInterface)
        }

        findViewById<Button>(R.id.readDeviceBattery).setOnClickListener {
            addPrint("readDeviceBattery")
            PPBluetoothPeripheralLorreInstance.readDeviceBattery(object : PPTorreDeviceModeChangeInterface {
        ...
        findViewById<Button>(R.id.readDeviceInfo).setOnClickListener {
            ...
            PPBluetoothPeripheralLorreInstance.readDeviceInfo(object : PPTorreDeviceModeChangeInterface {
        ...
        findViewById<Button>(R.id.toZeroKitchenScale).setOnClickListener {
            addPrint("To Zero")
            PPBluetoothPeripheralLorreInstance.toZero()
        }
        findViewById<Button>(R.id.startFoodManager).setOnClickListener {
            addPrint("startFoodManager")
            PPBluetoothPeripheralLorreInstance.startFoodManager(object : PPBleSendResultCallBack {
                override fun onResult(sendState: PPScaleSendState?) {
                    if (sendState == PPScaleSendState.PP_SEND_SUCCESS) {
        ...
        findViewById<Button>(R.id.exitFoodManager).setOnClickListener {
            ...
            syncDefaultFoodLorreEnd()
        }
        findViewById<Button>(R.id.delFood).setOnClickListener {
            addPrint("delFood")
            PPBluetoothPeripheralLorreInstance.deleteAllFood(object : PPFoodInfoInterface {
        ...
        findViewById<Button>(R.id.fetchFoodIdList).setOnClickListener {
            ...
            PPBluetoothPeripheralLorreInstance.getFoodList(object : PPFoodInfoInterface {
            ...
            if (foodList.isNullOrEmpty().not()) {
                PPBluetoothPeripheralLorreInstance.startFoodManager(object : PPBleSendResultCallBack {
                    override fun onResult(sendState: PPScaleSendState?) {
                        ...
                        // 同步食物信息到设备
                        PPBluetoothPeripheralLorreInstance.syncFoodInfos(foodList, object : PPFoodInfoInterface {
    ...
    fun syncDefaultFoodLorreEnd() {
        PPBluetoothPeripheralLorreInstance.endFoodManager(object : PPBleSendResultCallBack {
            override fun onResult(sendState: PPScaleSendState?) {
                if (sendState == PPScaleSendState.PP_SEND_SUCCESS) {
    ...
    override fun onDestroy() {
        super.onDestroy()
        PPBluetoothPeripheralLorreInstance.disConnect()
    }
    ...
    private val bleStateInterface = object : PPBleStateInterface() {
        ...
        override fun monitorBluetoothSwitchState(ppBleSwitchState: PPBleSwitchState?) {
            if (ppBleSwitchState == PPBleSwitchState.PPBleSwitchStateOff) {
                ...
                Toast.makeText(this@PeripheralLorreActivity, getString(R.string.system_bluetooth_disconnect), Toast.LENGTH_SHORT).show()
            } else if (ppBleSwitchState == PPBleSwitchState.PPBleSwitchStateOn) {
                addPrint(getString(R.string.system_blutooth_on))
                Toast.makeText(this@PeripheralLorreActivity, getString(R.string.system_blutooth_on), Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private val deviceLogInterface = object : PPDeviceLogInterface {
        ...
        override fun syncLogEnd(logFilePath: String?) {
            ...
            Toast.makeText(this@PeripheralLorreActivity, "Sync Log Success", Toast.LENGTH_SHORT).show()
            FileUtil.sendEmail(this@PeripheralLorreActivity, logFilePath)
        }
    ...
    fun createFoodDataList(): List<XinmiaoFoodScaleDefault> {
        ...
        return GsonUtil.jsonStirngToObj(dataJson, Array<XinmiaoFoodScaleDefault>::class.java)?.toList() ?: emptyList()
    }
