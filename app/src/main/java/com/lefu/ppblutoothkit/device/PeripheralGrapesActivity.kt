...
class PeripheralGrapesActivity : Activity() {
    ...
    val bleStateInterface = object : PPBleStateInterface() {
        ...
        override fun monitorBluetoothSwitchState(ppBleSwitchState: PPBleSwitchState?) {
            if (ppBleSwitchState == PPBleSwitchState.PPBleSwitchStateOff) {
                ...
                Toast.makeText(this@PeripheralGrapesActivity, getString(R.string.system_bluetooth_disconnect), Toast.LENGTH_SHORT).show()
            } else if (ppBleSwitchState == PPBleSwitchState.PPBleSwitchStateOn) {
                addPrint(getString(R.string.system_blutooth_on))
                Toast.makeText(this@PeripheralGrapesActivity, getString(R.string.system_blutooth_on), Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun getFoodValue(it: LFFoodScaleGeneral, deviceModel: PPDeviceModel) = FoodScaleCacluteHelper.getValue(
        this@PeripheralGrapesActivity, it.lfWeightKg.toFloat(), it.unit, deviceModel
    )
