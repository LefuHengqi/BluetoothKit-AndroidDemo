...
class PeripheralMorreActivity : BaseImmersivePermissionActivity() {
    ...
    fun initClick() {
        ...
        findViewById<Button>(R.id.syncTime).setOnClickListener {
            addPrint("syncTime")
            PPBluetoothPeripheralMorreInstance.syncTime { success ->
                if (success) {
        ...
        findViewById<Button>(R.id.toZeroKitchenScale).setOnClickListener {
            addPrint("To Zero")
            PPBluetoothPeripheralMorreInstance.toZero()
        }
        findViewById<Button>(R.id.startFoodManager).setOnClickListener {
            addPrint("startFoodManager")
            PPBluetoothPeripheralMorreInstance.startFoodManager(object : PPBleSendResultCallBack {
                override fun onResult(sendState: PPScaleSendState?) {
                    if (sendState == PPScaleSendState.PP_SEND_SUCCESS) {
        ...
        findViewById<Button>(R.id.delFood).setOnClickListener {
            addPrint("delFood")
            PPBluetoothPeripheralMorreInstance.deleteAllFood(object : PPFoodInfoInterface {
        ...
        findViewById<Button>(R.id.fetchFoodIdList).setOnClickListener {
            ...
            PPBluetoothPeripheralMorreInstance.getFoodList(object : PPFoodInfoInterface {
            ...
            if (foodList.isNullOrEmpty().not()) {
                PPBluetoothPeripheralMorreInstance.startFoodManager(object : PPBleSendResultCallBack {
                    override fun onResult(sendState: PPScaleSendState?) {
                        ...
                        // 同步食物信息到设备
                        PPBluetoothPeripheralMorreInstance.syncFoodInfos(foodList, object : PPFoodInfoInterface {
    ...
    fun syncDefaultFoodLorreEnd() {
        PPBluetoothPeripheralMorreInstance.endFoodManager(object : PPBleSendResultCallBack {
            override fun onResult(sendState: PPScaleSendState?) {
                if (sendState == PPScaleSendState.PP_SEND_SUCCESS) {
