...
//        val z100KhzLeftArmEnCode = z100KhzLeftArmEnCode.text?.toString()?.toLong() ?: 813513602L
//        val z100KhzLeftLegEnCode = z100KhzLeftLegEnCode.text?.toString()?.toLong() ?: 1624835934L
//        val z100KhzRightArmEnCode = z100KhzRightArmEnCode.text?.toString()?.toLong() ?: 1350381612L
//        val z100KhzRightLegEnCode = z100KhzRightLegEnCode.text?.toString()?.toLong() ?: 1883839216L
//        val z100KhzTrunkEnCode = z100KhzTrunkEnCode.text?.toString()?.toLong() ?: 12648481L
//        val z20KhzLeftArmEnCode = z20KhzLeftArmEnCode.text?.toString()?.toLong() ?: 569952335L
//        val z20KhzLeftLegEnCode = z20KhzLeftLegEnCode.text?.toString()?.toLong() ?: 1613474001L
//        val z20KhzRightArmEnCode = z20KhzRightArmEnCode.text?.toString()?.toLong() ?: 1908420737L
//        val z20KhzRightLegEnCode = z20KhzRightLegEnCode.text?.toString()?.toLong() ?: 808177276L
//        val z20KhzTrunkEnCode = z20KhzTrunkEnCode.text?.toString()?.toLong() ?: 1357348182L

//        val age 	=	27
//        val height 	=	180
//        val weight 	=	77.65
//        val sex 	=	PPUserGender.PPUserGenderMale
//        val z100KhzLeftArmEnCode 	=	813513602L
//        val z100KhzLeftLegEnCode 	=	1624835934L
//        val z100KhzRightArmEnCode 	=	1350381612L
//        val z100KhzRightLegEnCode 	=	1883839216L
//        val z100KhzTrunkEnCode 	=	12648481L
//        val z20KhzLeftArmEnCode 	=	569952335L
//        val z20KhzLeftLegEnCode 	=	1613474001L
//        val z20KhzRightArmEnCode 	=	1908420737L
//        val z20KhzRightLegEnCode 	=	808177276L
//        val z20KhzTrunkEnCode 	=	1357348182L

        val z100KhzLeftArmEnCode 	=	1888229468L
        val z100KhzLeftLegEnCode 	=	1356753294L
        val z100KhzRightArmEnCode 	=	270329272L
        val z100KhzRightLegEnCode 	=	30722042L
        val z100KhzTrunkEnCode 	=	268489705L
        val z20KhzLeftArmEnCode 	=	282012097L
        val z20KhzLeftLegEnCode 	=	1342896067L
        val z20KhzRightArmEnCode 	=	540883894L
        val z20KhzRightLegEnCode 	=	810164128L
        val z20KhzTrunkEnCode 	= 1616157080L
