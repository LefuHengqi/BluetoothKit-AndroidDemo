 ...
 *    desc   :对换框的基类
 */
abstract class BaseLeFuWhsDialog<T : BaseLeFuWhsDialog<T>> : DialogFragment() {
    ...
    init {
        setStyle(STYLE_NORMAL, R.style.dialog_)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewHandlerListener?.convertView(ViewHolderComnonDialogWhs.create(view), this)
        initView(view)
