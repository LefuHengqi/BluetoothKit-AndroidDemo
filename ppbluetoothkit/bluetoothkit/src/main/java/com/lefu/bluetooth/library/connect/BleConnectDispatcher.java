...
import com.lefu.bluetooth.library.RuntimeChecker;
import com.lefu.bluetooth.library.connect.options.BleConnectOptions;
import com.lefu.bluetooth.library.connect.request.BleConnectRequest;
import com.lefu.bluetooth.library.connect.request.BleIndicateRequest;
import com.lefu.bluetooth.library.connect.request.BleMtuRequest;
import com.lefu.bluetooth.library.connect.request.BleNotifyRequest;
import com.lefu.bluetooth.library.connect.request.BleReadDescriptorRequest;
import com.lefu.bluetooth.library.connect.request.BleReadRequest;
import com.lefu.bluetooth.library.connect.request.BleReadRssiRequest;
import com.lefu.bluetooth.library.connect.request.BleRefreshCacheRequest;
import com.lefu.bluetooth.library.connect.request.BleRequest;
import com.lefu.bluetooth.library.connect.request.BleUnnotifyRequest;
import com.lefu.bluetooth.library.connect.request.BleWriteDescriptorRequest;
import com.lefu.bluetooth.library.connect.request.BleWriteNoRspDirectRequest;
import com.lefu.bluetooth.library.connect.request.BleWriteNoRspRequest;
import com.lefu.bluetooth.library.connect.request.BleWriteRequest;
...
public class BleConnectDispatcher implements IBleConnectDispatcher, RuntimeChecker, Handler.Callback {
    ...
    public void connect(BleConnectOptions options, BleGeneralResponse response) {
        if (BleWriteNoRspDirectRequest.getInstance() != null) {
            BleWriteNoRspDirectRequest.getInstance().init();
        }
    ...
    public void writeNoRspDirectly(UUID service, UUID character, byte[] bytes, BleGeneralResponse response) {
        BluetoothLog.d("BleConnectDispatcher writeNoRspDirectly");
        BleWriteNoRspDirectRequest noRspDirectRequest = BleWriteNoRspDirectRequest.getInstance(response);
        noRspDirectRequest.setRuntimeChecker(this);
        noRspDirectRequest.setAddress(mAddress);
        noRspDirectRequest.setWorker(mWorker);
        noRspDirectRequest.process(this);
        noRspDirectRequest.startWrite(service, character, bytes);
        BluetoothLog.d("BleConnectDispatcher writeNoRspDirectly end");
    }
