...
public class BleConnectRequest extends BleRequest implements ServiceDiscoverListener {
    ...
    public boolean isNeedRetryConnect() {
        return mConnectCount < mConnectOptions.getConnectRetry() + 1;
    }
    ...
    private void processConnectTimeout() {
        onRequestCompleted(Code.REQUEST_TIMEDOUT);
