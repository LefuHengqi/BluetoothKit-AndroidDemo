...
import com.lefu.bluetooth.library.search.BluetoothSearchManager;
...
import static com.lefu.bluetooth.library.Constants.CODE_WRITE_NORSP_DIRECTLY;
...
public class BluetoothServiceImpl extends IBluetoothService.Stub implements Handler.Callback {
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case CODE_WRITE_NORSP_DIRECTLY:
                BleConnectManager.writeNoRspDirectly(mac, service, character, value, response);
                break;
