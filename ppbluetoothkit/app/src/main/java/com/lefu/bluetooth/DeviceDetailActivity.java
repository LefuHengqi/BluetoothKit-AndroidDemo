...
import static com.lefu.bluetooth.library.Constants.*;
...
public class DeviceDetailActivity extends Activity {
    ...
    private void connectDevice() {
        ...
        byte[] bytes = ByteUtils.stringToBytes("0715000337000127");//000000000000

        UUID uuid = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");

//        ClientManager.getClient().startAdvertising(uuid,
//                null, "Phone", true, bytes, 0, 0x0000, new AdvertisingResponse() {
//                    @Override
...
//                });
    ...
    protected void onDestroy() {
        ClientManager.getClient().stopAdvertising(null);
